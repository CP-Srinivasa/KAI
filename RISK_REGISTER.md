...
|---|---|---|---|
| **RF-8** | research.py God-File (3424 Zeilen, 57 Commands) | implemented | 995eb3a Ã¢ÂÂ split into 4 Submodule |
| **RF-9** | API auth guard fehlt in production | implemented | 144da3c Ã¢ÂÂ validate_secrets fail-fast |
| **RF-10** | IdempotencyStore / RateLimitStore inline | implemented | 3262abb Ã¢ÂÂ Store-Klassen mit Single-Instance-Warnung |
| **RF-11** | Property-Based Tests Risk-Engine fehlten | implemented | 3f69cf8 Ã¢ÂÂ 7 Hypothesis-Invarianten |
...
- PH4J findings: fallback tags enriched with categories, affected_assets, source_name, market_scope.value; keyword-hit 4Ã¢ÂÂ7, zero-hit 1Ã¢ÂÂ4, assets-only 0Ã¢ÂÂ4; PH4J formally closed (D-80); Ãpar78 frozen anchor.
