...
def test_edge_report_groups_by_source_mixed_cohort():
    ...
    trades = [
        ClosedTrade(
            "BTC/USDT", "long", 100.0, 110.0, 1.0, "tp", 9.0, 1.0,
            "2026-06-01T10:00:00+00:00", "unknown", "canary_probe",
        ),
        ClosedTrade(
            "ETH/USDT", "long", 100.0, 90.0, 1.0, "sl", -11.0, 1.0,
            "2026-06-01T11:00:00+00:00", "unknown", "canary_probe",
        ),
        ClosedTrade(
            "XRP/USDT", "long", 100.0, 112.0, 1.0, "tp", 11.0, 1.0,
            "2026-06-01T12:00:00+00:00", "unknown", "autonomous_generator",
        ),
    ]
