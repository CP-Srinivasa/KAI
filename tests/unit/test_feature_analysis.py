...
def test_totals_reflect_hit_miss_inconclusive_unlabeled() -> None:
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 8),
        _audit("d2", "bullish", ["BTC/USDT"], 8),
        _audit("d3", "bearish", ["ETH/USDT"], 6),
        _audit("d4", "bullish", ["BTC/USDT"], 5),  # inconclusive
...
def test_asset_bucket_counts_multi_asset_alerts_in_each_bucket() -> None:
    audits = [
        _audit("d1", "bullish", ["BTC/USDT", "ETH/USDT"], 8),
        _audit("d2", "bullish", ["BTC/USDT"], 8),
        _audit("d3", "bearish", ["ETH/USDT"], 6),
    ]
    annotations = [
...
def test_priority_group_high_vs_low() -> None:
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 8),  # high
        _audit("d2", "bullish", ["BTC/USDT"], 9),  # high
        _audit("d3", "bullish", ["BTC/USDT"], 5),  # low
        _audit("d4", "bullish", ["BTC/USDT"], 5),  # low
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "hit"),
...
def test_forward_simulation_filters_bearish() -> None:
    ...
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 8),
        _audit("d2", "bearish", ["BTC/USDT"], 8),
        _audit("d3", "bullish", ["ETH/USDT"], 9),
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "miss"),
...
def test_forward_simulation_filters_low_priority() -> None:
    ...
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 9),
        _audit("d2", "bullish", ["BTC/USDT"], 7),  # blocked
        _audit("d3", "bullish", ["BTC/USDT"], 5),  # blocked
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "miss"),
...
def test_forward_simulation_filters_not_actionable() -> None:
    ...
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 8, actionable=True),
        _audit("d2", "bullish", ["BTC/USDT"], 8, actionable=False),
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "miss"),
...
def test_forward_simulation_combined_filters() -> None:
    ...
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 9),  # passes all
        _audit("d2", "bearish", ["BTC/USDT"], 9),  # bearish block
        _audit("d3", "bullish", ["BTC/USDT"], 7),  # priority block
        _audit("d4", "bullish", ["BTC/USDT"], 8),  # source block
        _audit("d5", "bullish", ["ETH/USDT"], 8),  # passes
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "miss"),
...
def test_forward_simulation_uses_title_by_doc_fallback() -> None:
    ...
    audits = [
        _audit("d1", "bullish", ["BTC/USDT"], 9),  # no title
        _audit("d2", "bullish", ["BTC/USDT"], 10),  # no title
    ]
    annotations = [
        _ann("d1", "hit"),
        _ann("d2", "miss"),
...
def test_excludes_digests_and_non_directional_sentiments() -> None:
    audits = [
        ...
        _audit("d-mixed", "mixed", ["BTC/USDT"], 8),  # non-directional
        _audit("d-real", "bullish", ["BTC/USDT"], 8),
    ]
