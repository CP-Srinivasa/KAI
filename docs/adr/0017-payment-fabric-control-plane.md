...
| **Fremd-Rails** | Nur `RailCapabilities`-Felder im Domänenmodell; **kein** `SepaRail`/`PspRail`-Modul, kein Stub | ADR 0016: Merchant/PSP/Dritte = Tier-2-STOP; jeder Fremd-Rail braucht ein eigenes ADR |
