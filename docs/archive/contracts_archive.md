# contracts_archive.md — Closed Contract Archive

> All sections below are closed/frozen historical records.
> § numbers are preserved permanently (never renumber).
> Active contracts: see docs/contracts.md
...
§81 status: **closed (D-86, 2026-03-24)**

---

## §82 — PHASE4_CLOSEOUT_AND_NEXT_PHASE_GATE

**Sprint**: Phase 4 Closeout
**Phase**: 4 (final)
**Opened**: 2026-03-24
**Decision**: D-87
**Status**: active gate
...
| Tags empty | 100% (69/69) | 37.7% (26/69) | -62.3% |
| Relevance=0 | 81.2% (56/69) | 37.7% (26/69) | -43.5% |
| Scope unknown | 100% (69/69) | 68.1% (47/69) | -31.9% |
| Watchlist overlap | — | 52.2% (36/69) | — |

### Permanent Constraints Carried Forward

- **I-13**: `actionable` is LLM-exclusive. Rule-only fallback: `actionable=False`. No relaxation.
- **V-4**: DB-primary portfolio snapshot via `PortfolioStateRecord`; JSONL fallback; DB errors non-fatal.
...
## Archived from contracts.md (D-108, 2026-03-25)

> Companion-ML contracts (§12-§15) moved here during D-107/D-108 cleanup.
> These sections describe frozen companion-ML infrastructure (strategic hold D-97).
...
Historical architecture context was retired with D-106/D-107.
Use `DECISION_LOG.md` and `docs/archive/contracts_archive.md` for closed legacy context.

Status note (2026-03-25):
- Companion-model infrastructure is on strategic hold and not part of the active production decision path.
- Active production path remains ingestion → analysis → signals → alerts.
...
Status note (2026-03-25):
- Companion-model implementation details here are historical/compatibility context.
- Operational decisions must prioritize active runtime behavior in code and tests.
...
## Archived Companion-ML Invariants (I-14..I-93) — D-108, 2026-03-25

> Moved from contracts.md during D-108 cleanup. These invariants describe
> frozen companion-ML infrastructure under strategic hold D-97.
