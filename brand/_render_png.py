...
def _draw_mark(draw: ImageDraw.ImageDraw, scale: float, color=FG) -> None:
    ...
    # K stem
    draw.rectangle(_s((22, 18), (38, 110)), fill=color)
    # K upper diagonal — extends above top edge as chevron
    draw.polygon(_s((38, 64), (96, 6), (110, 22), (52, 80)), fill=color)
    # K lower diagonal
    draw.polygon(_s((38, 64), (82, 110), (66, 110), (30, 72)), fill=color)
...
def _draw_wordmark(draw: ImageDraw.ImageDraw, scale: float, color=FG) -> None:
    ...
    # K
    draw.rectangle(_s((14, 10), (28, 86)), fill=color)
    draw.polygon(_s((28, 48), (78, 4), (90, 16), (40, 60)), fill=color)
    draw.polygon(_s((28, 48), (70, 90), (56, 90), (22, 56)), fill=color)

    # A — two legs as trapezoids + crossbar + apex cap
    draw.polygon(_s((128, 90), (142, 90), (166, 18), (152, 18)), fill=color)
    draw.polygon(_s((162, 18), (176, 18), (200, 90), (186, 90)), fill=color)
    draw.rectangle(_s((144, 54), (184, 64)), fill=color)
    draw.polygon(_s((152, 18), (176, 18), (164, 6)), fill=color)

    # I
    draw.rectangle(_s((222, 10), (236, 86)), fill=color)
