...
`priority_rejected` rather than fills. Live Pi posture on 2026-06-17 is
`EXECUTION_ENTRY_MODE=paper_learning`; any further promotion still requires
`trading edge-gate` and operator review.
