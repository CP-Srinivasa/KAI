...
Eine vierte Richtung gab es waehrend des Dual-Read (ADR §12): Journal gegen
Journal. Sie ist mit PR 2 entfallen, weil es kein zweites Buch mehr gibt — das
alte v2-Journal ist Archiv ohne Leser und ohne Schreiber. Ein Pass, der immer
gegen eine leere Menge laeuft, ist keine Wache, sondern eine Zusage ohne
Deckung.
