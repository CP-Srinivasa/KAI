"""Canonical runtime JSON Schema validation for KAI.

This module is the single runtime source of truth for payload schema binding.
All runtime config and decision payload validation must flow through here.
"""
